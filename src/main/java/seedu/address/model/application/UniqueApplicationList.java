 ...
 * adding and updating of applications uses Application#isSameApplication(Application) for equality to ensure that the
 * application being added or updated is unique in terms of identity in the UniqueApplicationList. However,
 * the removal of an application uses Application#equals(Object) to ensure that the application with exactly
