...
public class TypicalPersons {
    ...
    public static final Person ALICE = new PersonBuilder().withName("Alice Pauline")
            ...
            .withPhone("94351253").withWebsite("https://alice.com")
    ...
    public static final Person AMY = new PersonBuilder().withName(VALID_COMPANY_NAME_AMAZON).withPhone(VALID_PHONE_AMY)
            .withEmail(VALID_EMAIL_AMY).withWebsite(VALID_WEBSITE_AMY)
            .withAddress(VALID_ADDRESS_AMY).withTags(VALID_TAG_FRIEND).build();
    public static final Person BOB = new PersonBuilder().withName(VALID_COMPANY_NAME_BMW).withPhone(VALID_PHONE_BOB)
